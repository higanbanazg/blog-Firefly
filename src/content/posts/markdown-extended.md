...
::github{repo="higanbanazg/blog-Firefly"}

使用代码 `::github{repo="higanbanazg/blog-Firefly"}` 创建 GitHub 仓库卡片。
...
[grid]
![示例图片一](./images/demo1.avif)
![示例图片二](./images/demo2.avif)
![示例图片二](./images/demo3.avif)
[/grid]
