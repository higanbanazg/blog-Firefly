...
export const site = {
  ...
  avatar: "https://github.com/higanbanazg.png",
      ...
      <div class="p-5 sm:p-6 flex flex-col flex-1">
        ...
        <div class="space-y-0 flex-1">
          ...
          <div class="flex gap-3.5">
            ...
            <div class="pb-4">
              <p class="font-semibold text-sm mb-1">评论区留言/发送申请至telegram：<a href={site.telegramUrl} target="_blank" rel="noopener noreferrer" class="px-1.5 py-0.5 rounded bg-black/5 dark:bg-white/10 text-[0.7rem] hover:opacity-80 transition-opacity">{site.telegram}</a></p>
              <p class="text-xs text-neutral-500 dark:text-neutral-400 leading-relaxed">申请模板，把内容复制修改后到评论区或 Telegram 发送</p>
